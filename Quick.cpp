...
/// <summary>
/// Version du tuto "opengl-tutorial", pas celle du prof
/// </summary>
/// <param name="path"> Fichier OBJ à load </param>
/// <param name="out_vertices"> Sommets </param>
/// <param name="out_uvs"> coordonnées UV </param>
/// <param name="out_normals"> Normales </param>
/// <returns> False si qqch s'est mal passé </returns>
bool loadOBJ(const char* path, vector < vec3 >& out_vertices, vector < vec2 >& out_uvs, vector < vec3 >& out_normals) {
	...
	if (file == NULL) {
		printf("Impossible to open the file ! T'es perdu mon reuf\n");
		return false;
	}
